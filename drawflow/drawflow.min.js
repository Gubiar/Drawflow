            ...
            class i {
                ...
                click(e) {
                    if ((this.dispatch("click", e), "fixed" === this.editor_mode)) {
                        ...
                        "view" === this.editor_mode
                            ? (null != e.target.closest(".ƒdrawflow") || e.target.matches(".parent-drawflow")) &&
                    ...
                    switch (this.ele_selected.classList[0]) {
                        case "drawflow-node":
                            null != this.node_selected &&
                                ...
                                this.node_selected.addEventListener("click", (event) => {
                                    if(this.node_selected){

                                        var elements = document.getElementsByClassName("drawflow-node");
                                        for(var i = 0; i < elements.length; i ++){
                                            elements[i].style.zIndex = '2';
                                        }

                                        this.node_selected.style.zIndex = '3';
                                        this.node_selected.appendChild(document.getElementById("floatingDivNode"));
                        ...
                        case "output":
                            (this.connection = !0),
                                null != this.node_selected &&
                                    (this.node_selected.classList.remove("selected"), (this.node_selected = null), this.dispatch("nodeUnselected", !0)),
                                null != this.connection_selected &&
                                    (this.connection_selected.classList.remove("selected"),
                                    this.removeReouteConnectionSelected(),
                                    (this.connection_selected = null)),
                    ...
                    "touchstart" === e.type
                        ...
                        ["input", "output", "main-path"].includes(this.ele_selected.classList[0]) && e.preventDefault(),
                ...
                dragEnd(e) {
                    ...
                    if (
                        ...
                        if (
                            "input" === i.classList[0] ||
                            (this.force_first_input && (null != i.closest(".drawflow_content_node") || "drawflow-node" === i.classList[0]))
                        ) {
                            if (!this.force_first_input || (null == i.closest(".drawflow_content_node") && "drawflow-node" !== i.classList[0]))
                ...
                drawConnection(e) {
                    ...
                    n.classList.add("main-path"),
                        n.addEventListener("click", function (event) {
                            ...
                            document.getElementById("floatingDiv").style.left = Number(mouseX + 20) + "px";
                            document.getElementById("floatingDiv").style.top = Number(mouseY - 20) + "px";

                            // Exibe a div flutuante
                            console.log("display block");
                            document.getElementById("floatingDiv").style.display = "flex";
                        }),
                        ...
                        if (null === f[t].querySelector(".point")) {
                            ...
                            n.forEach((t, a) => {
                                if (0 === a && n.length - 1 == 0) {
                                    ...
                                    (o += y), m.push(y);
                                    (f = t),
                                        (g = ((x = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (_ = (x.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (w = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (v = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (y = l(w, v, g, _, c, "other"));
                                    ...
                                    (f = t),
                                        (g =
                                            ((x = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) * (s.clientWidth / (s.clientWidth * h)) +
                                            r),
                    ...
                    Object.keys(m).map(function (t, n) {
                        if (null === m[t].querySelector(".point")) {
                            var h = i.querySelector("#" + e),
                                ...
                                v =
                                    (h = h.querySelectorAll("." + m[t].classList[4])[0]).offsetWidth / 2 +
                            ...
                            n.forEach((t, a) => {
                                if (0 === a && n.length - 1 == 0) {
                                    ...
                                    (m =
                                        ...
                                        (g = x.offsetHeight / 2 + (x.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                    ...
                                    (f = t),
                                        ...
                                        (m = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (g = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (v = l(m, g, _, w, c, "other"));
                                    (o += v), h.push(v);
                                } else if (a === n.length - 1) {
                                    var L, E;
                ...
                createReroutePoint(e) {
                    ...
                    void 0 === this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points &&
                        ...
                        this.reroute_fix_curvature
                            ? (d > 0 || this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points !== []
                        ...
                        if (t[n].nodeName.startsWith("df-")) {
                            for (
                                var i = t[n].nodeName.slice(3).split("-"),
                                    s = this.drawflow.drawflow[this.module].data[e.target.closest(".drawflow_content_node").parentElement.id.slice(5)].data,
                                    o = 0;
                                o < i.length - 1;
                                o += 1
                            )
                ...
                removeSingleConnection(e, t, n, i) {
                    ...
                    if (s === this.getModuleFromNodeId(t)) {
                        if (
                            ...
                            this.module === s &&
                                this.container.querySelector(".connection.node_in_node-" + t + ".node_out_node-" + e + "." + n + "." + i).remove();
